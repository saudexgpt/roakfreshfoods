            ...
            <div class="col-xs-12">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td colspan="5" align="right"><label>In Words: {{ inWords(invoice.amount).toUpperCase() }}</label></td>
                  </tr>
                </tbody>
              </table>
              <p>
...
export default {
  ...
  methods: {
    ...
    moment,
    doPrint() {
      document.getElementById('printableArea').setAttribute('class', 'invoice');
      window.print();
    },
