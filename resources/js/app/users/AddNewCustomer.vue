<template>
  <el-dialog :title="'Create new customer'" width="30%" :visible.sync="dialogFormVisible" :before-close="closeModal">
    <div v-loading="userCreating" class="form-container">
      <el-form ref="newCustomer" :rules="rules" :model="newCustomer" label-position="left" label-width="150px">
