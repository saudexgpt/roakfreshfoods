<template>
  <div class="box">
    <div class="box-header">
      <h4 class="box-title">Add Product Quantity to Stock</h4>
          ...
          <el-form ref="form" :model="form" label-width="120px">
            <el-row :gutter="5" class="padded">
              <el-col :xs="24" :sm="12" :md="12">
                ...
                <el-select v-model="form.warehouse_id" placeholder="Select Store" filterable class="span">
...
export default {
  ...
  methods: {
    ...
    fetchItemDetails(index) {
      ...
      app.sub_batches[index].type = item.basic_unit;
