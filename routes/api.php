...
$router->group(['middleware' => 'auth:api'], function () use ($router) {
    ...
    $router->group(['prefix' => 'reports'], function () use ($router) {
        ...
        $router->group(['prefix' => 'graphical'], function () use ($router) {
            ...
            $router->get('sales-by-items', 'ReportsController@salesByItems')->middleware('permission:view reports');
    ...
    $router->group(['prefix' => 'expense', 'namespace' => 'Expenses'], function () use ($router) {

        $router->get('/', 'ExpensesController@index');

        $router->post('store', 'ExpensesController@store');

        $router->put('update/{expense}', 'ExpensesController@update');

        $router->delete('delete/{expense}', 'ExpensesController@destroy');
