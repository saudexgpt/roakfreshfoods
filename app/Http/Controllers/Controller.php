...
class Controller extends BaseController
{
    ...
    public function fetchNecessayParams()
    {
        ...
        $package_types = ['Bags', 'Cartons', 'Kilo', 'Ltrs', 'Packets', 'Pieces'];
        ...
        return response()->json([
            'params' => compact('company_name', 'company_contact', 'all_warehouses', 'warehouses', 'items', 'currencies', 'taxes', /*'order_statuses',*/ 'invoice_statuses', 'currency', 'categories', 'engine_types', 'expense_types', 'package_types', 'all_roles', 'default_roles', 'product_return_reasons', 'product_expiry_date_alert', 'teams', 'dispatch_companies', 'customer_types', 'enable_stock_quantity_check_when_raising_invoice', 'product_types')
        ]);
    }
